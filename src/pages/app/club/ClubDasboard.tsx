...
import { ActivitySection } from "../../../components/club/dasboard/ActivitySection";
import { ClubAndCoachSection } from "../../../components/club/dasboard/ClubAndCoachSection";
import {
  mockActivity,
  mockClubSummary,
  mockCoach,
  mockPlayers,
  mockUpcoming,
} from "../../../components/club/dasboard/mock";
import { OverviewSection } from "../../../components/club/dasboard/OverviewSection";
import { PlayersSection } from "../../../components/club/dasboard/PlayersSection";
import { Header } from "../../../components/pageHeader/Header";
...
export const ClubDashboard = () => {
  // TODO: docelowo: const { clubId } = useClubContext()
  const club = mockClubSummary;
  ...
  return (
    <div className="space-y-6">
      {/* Header zostawiasz jak masz */}
      <Header
        title="Przegląd klubu"
        subtitle="Najważniejsze informacje w jednym miejscu"
      />

      <div className="grid gap-6 lg:grid-cols-[3fr_2fr]">
        <ClubAndCoachSection club={club} coach={coach} />
        <OverviewSection upcoming={upcoming} />
      </div>
      <PlayersSection players={players} totalPlayers={club.kpis.playersCount} />
